...
description: >-
  A dive into Azure DevOps projects, and how to setup automation to create one.
pubDate: 'Jun 09 2018'
heroImage: ../../assets/images/devops-project/FunctionDevopsProject.png
category: Azure
tags: 
    - Azure
    - Automation
...
`DevOps Projects` as an azure resource never went GA and was removed from preview by Microsoft.
...
![Azure DevOps Project in wizard](../../assets/images/devops-project/DevopsProjectInPortal.png)
...
![DevOps Project wizard source control step](../../assets/images/devops-project/WizardOwnCodeStepOne.png)
...
![Devops Project Wizard Azure service step](../../assets/images/devops-project/WizardOwnCodeStepThree.png)
...
![Initial portal view](../../assets/images/devops-project/DevopsPortal.png)
...
![Installer configuration change](../../assets/images/devops-project/InstallerVersionNumber.png)
...
![Edited publish configuration](../../assets/images/devops-project/FinalPublishConfiguration.png)
...
![Completed deploy task configuration](../../assets/images/devops-project/CompletedDeployConfig.png)
...
![Azure Function configuration](../../assets/images/devops-project/AzureFunctionConfiguration.png)

## Was all that worth it?

![Final DevOps Project portal view](../../assets/images/devops-project/FunctionDevopsProject.png)
